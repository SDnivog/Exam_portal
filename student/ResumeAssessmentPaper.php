...
if($result->num_rows>0){
    ...
    $record_id_data = $row_data['record_id'];
    
    $left_time = $row_data['end_time'];
...
<body id="mybody">
   ...
   <div class="container-fluid pb-5">
           <form onsubmit="return checkForm(this);" action="pages/submit_resume_assessment.php" class="p-3" method="POST" name="quiz" id="quiz_form">
    <nav  class="navbar fixed-top navbar-light bg-white shadow">
   <div class="container">
    <a href="javascript:void()" class="navbar-brand"><img src="../logo.png" style="width:80px;"></a>
    <span class="navbar-text" style="font-size: 16px;font-weight:600;"><span id="quiz-time-left"></span></span> 
       <input class="submit_button btn btn-link" type="button" style="font-size:15px;" id="submit_btn" onclick="StartModel()" value="Submit Exam">
   </div>
    </nav>
    ...
    <nav class="container sub nav-justified mb-3" style="margin-top: 80px;">
      ...
      <div class="tab-content" id="nav-tabContent">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4  col-2 pb-3 borderr">
                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                        	...
                        	<?php 
                                            ...
                                            while($row = $result->fetch_assoc()) {
                                                ...
                                                $question_id_data = $row['question_id'];
                                                $sql_checking= "select * from tbl_responses where question_id='$question_id_data' and stu_response != '' and stu_id='$stu_id'";
                                                
                                                $result_checking = $conn->query($sql_checking);
                                                
                                                if($result_checking->num_rows>0){
                                                    
                                                    $class_type = 'background-color:rgb(65,148,65);color:whitesmoke';
                                    ...
                                    <a class="qlink active "';
                                    
                                    if($class_type != ''){
                                        print 'style="'.$class_type.'"';
                                    }
                                    
                                    print 'id="pills-sub1q'.$qno.'-tab" data-toggle="pill" href="#pills-sub1q'.$qno.'" onclick="next('.$qno.','.$type.')" role="tab" aria-controls="pills-sub1q1" aria-selected="true">'.$qno.'  </a>
                ...
                <div class="col-md-8  col-10 py-3 px-1 sec_border">
                       	...
                       	<?php 
                                            ...
                                            while($row = $result->fetch_assoc()) {
												...
												$enan = $row[$ans];
												 ...
												 $sql_checking1= "select * from tbl_responses where question_id='$qsid' and stu_response != '' and stu_id='$stu_id'";
                                                
                                                $result_checking1 = $conn->query($sql_checking1);
                                                
                                                $row_checking = $result_checking1->fetch_assoc();
											    ...
											    if($qno == 1 ){
											     ...
											     if($question_type == "STQ"){
                                                    ...
                                                    <option value="Hindi">Hindi</option>
                                                          ...
                                                          print '
                                                    <div class="container mb-3" style="overflow: auto;">
                                                        <img src="../admin/pages/'.$Image.'" id="english'.$qno.'" alt="" style="min-width:100%;">
                                                    </div>';
                                                    print '
                                                    <div class="container mb-3" style="overflow: auto;">
                                                        <img src="../admin/pages/'.$Hindi_Image.'" id="hindi'.$qno.'" alt="" style="min-width:100%;display:none">
                                                    </div>';
                                                    }
                                                    ...
                                                    /// if answer is checked
                                                     if($result_checking1->num_rows>0){
                                                      for($i=1;$i<5;$i++){
                                                        //   $arr = ['A','B','C','D'];
                                                          if($row_checking['stu_response'] == $row['option'.$i]){
                                                               print '<div class="form-check">
                                                          <input class="form-check-input" checked="checked" type="radio" name="an'.$qno.'" value="'.$row['option'.$i].'" id="option'.$i.$qno.'">
                                                    ...
                                                    <div class="container mb-3" style="overflow: auto;">
                                                     ...
                                                     if($result_checking1->num_rows>0){
                                                      for($i=1;$i<5;$i++){
                                                          ...
                                                          if(strpos($row_checking['mul_response'] ,'option'.$i)  !== false){
                                                                print '  <div class="form-check ">
                                                                    <input class="form-check-input" name="an'.$i.$qno.'" checked="checked"  type="checkbox" value="'.$row["option".$i].'" id="option'.$i.$qno.'">
                                                                    <label class="form-check-label" for="option'.$i.$qno.'">'.$row["option".$i].'</label>
                                                                  </div>';
                                                ...
                                                if(!empty($Image) and empty($Hindi_Image)){
                                                  ...
                                                  <div class="form-group">
                                                   <input  type="text" value="'.$row_checking["stu_response"].'" class="form-control form-control-sm fill_type" placeholder="Enter Your Answer" name="an'.$qno.'" id="fill'.$qno.'">
                                                  </div>
                                            </div>'; 
                                                    ...
                                                    <div class="container mb-3" style="overflow: auto;">
                                                     ...
                                                     if($result_checking1->num_rows>0){
                                                      for($i=1;$i<3;$i++){
                                                        //   $arr1 = ['true','false'];
                                                           $arr = ['true','false'];
                                                          if($row_checking['stu_response'] == $arr[$i-1]){
                                                            print '  <div class="form-check">
                                                            <input class="form-check-input" checked="checked" type="radio" name="an'.$qno.'"   value="'.$arr[$i-1].'" id="true'.$i.$qno.'">
                                       ...
                                       print'
											...
											<input type="hidden" name="ri" value="<?php echo "$record_id_data"; ?>">
                ...
                <div class="col-md-4  col-2 pb-3 borderr">
                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                        	...
                        	<?php 
                                    ...
                                    print 'id="pills-sub1q'.$main_out.$qno.'-tab" data-toggle="pill" href="#pills-sub1q'.$main_out.$qno.'" onclick="sectionquestion('.$qno.','.$type.',-10)" role="tab" aria-controls="pills-sub1q1" aria-selected="true">'.$qno.'  </a>
                       	...
                       	<?php 
                                            ...
                                            while($row = $result->fetch_assoc()) {
                                                     ...
                                                     if($result_checking1->num_rows>0){
                                                      for($i=1;$i<5;$i++){
                                                        //   $arr = ['A','B','C','D'];
                                                          if($row_checking['stu_response'] == $row['option'.$i]){
                                                              print '<div class="form-check">
                                                          <input class="form-check-input" type="radio" checked="checked" name="an'.$main_out.$qno.'" value="'.$row['option'.$i].'" id="option'.$main_out.$i.$qno.'">
                                                          <label class="form-check-label" for="option'.$i.$qno.'">'.$row['option'.$i].'</label>
                                                        </div>';
                                                    ...
                                                    <div class="container mb-3" style="overflow: auto;">
                                                     ...
                                                     if($result_checking1->num_rows>0){
                                                      for($i=1;$i<5;$i++){
                                                          ...
                                                          if(strpos($row_checking['mul_response'] ,'option'.$i)  !== false){
                                                                print '  <div class="form-check ">
                                                                    <input class="form-check-input" name="an'.$main_out.$i.$qno.'" checked="checked" type="checkbox" value="'.$row["option".$i].'" id="option'.$main_out.$i.$qno.'">
                                                                    <label class="form-check-label" for="option'.$i.$qno.'">'.$row["option".$i].'</label>
                                                                  </div>';
                                                ...
                                                if(!empty($Image) and empty($Hindi_Image)){
                                                 ...
                                                 print '
                                                  <div class="form-group">
                                                   <input  type="text" class="form-control form-control-sm fill_type" value="'.$row_checking["stu_response"].'" placeholder="Enter Your Answer" name="an'.$main_out.$qno.'" id="fill'.$main_out.$qno.'">
                                                  </div>
                                            </div>';
                                                     ...
                                                     if($result_checking1->num_rows>0){
                                                      for($i=1;$i<3;$i++){
                                                        //   $arr1 = ['true','false'];
                                                          ...
                                                          if($row_checking['stu_response'] == $arr[$i-1]){
                                                             print '  <div class="form-check">
                                            <input class="form-check-input" type="radio" name="an'.$main_out.$qno.'" checked="checked"  value="'.$arr[$i-1].'" id="true'.$main_out.$i.$qno.'">
                                            <label class="form-check-label" for="inlineRadio2">'.$arr[$i-1].'</label>
                                          </div>';
                                                          }else{
                                                         print '  <div class="form-check">
                               ...
                               print '<button type="button" onclick="ClearOptionQuestion('.$qno.',2)">Clear Option</button>'; 
                                       ...
                                       print'
                                                ...
                                                echo '<input type="hidden" value="1" id="typevalue'.$out.'">'; 
                                            }
...
function keyup(e){
  ...
  function ActiveCurrent(id,type){
	 ...
	 function ClearOptionQuestion(id,type){
        ...
        $(document).on('fullscreenchange webkitfullscreenchange mozfullscreenchange MSFullscreenChange', function() {
        	if(IsFullScreenCurrently()) {
                document.querySelector('#submit_btn').setAttribute( "onClick", "StartModel();" );
        	}
        	else {
