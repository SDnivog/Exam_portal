...
$sql = "SELECT * FROM tbl_categories WHERE user_id = '$login_user_id' AND name = '$category_name' AND department = '$department_name'";
...
$sql = "INSERT INTO tbl_categories (user_id,category_id, name, department, date_registered)
VALUES ('$login_user_id','$category_id', '$category_name', '$department_name', '$date_registered')";
