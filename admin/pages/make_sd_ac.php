...
$sql1 = "UPDATE tbl_account SET acc_status='1' WHERE student_id='$sid'  and department='$department' and category='$class' and teacher_id='$tid'";
...
$sql = "UPDATE tbl_account SET acc_stat='1' WHERE user_id='$sid' and department='$department' and category='$class' and teacher_id='$tid'";
