...
$sql = "SELECT * FROM tbl_departments WHERE user_id = '$login_user_id' and name = '$department_name'";
...
$sql = "INSERT INTO tbl_departments ( user_id,department_id, name, date_registered)
VALUES ('$login_user_id','$department_id', '$department_name', '$date_registered')";
