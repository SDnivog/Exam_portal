...
$sql = "SELECT * FROM tbl_subjects WHERE user_id = '$login_user_id' AND name = '$subject_name' AND department = '$department_name' AND category = '$category_name'";
...
$sql = "INSERT INTO tbl_subjects (user_id,subject_id, name, department, category, date_registered)
VALUES ('$login_user_id','$subject_id', '$subject_name', '$department_name', '$category_name', '$date_registered')";
