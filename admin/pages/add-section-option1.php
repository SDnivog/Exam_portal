...
//   if(!empty($mainanswer)){
    ...
    // $sql = "select * from tbl_questions where exam_id='$exam_id' and question_id='$question_id and answer='$answer' and question='$questions'";
    ...
    // }else{
          ...
          if(!empty($_POST['question'.$sec_name.$i])){
...
//     // $sql = "select * from tbl_questions where exam_id='$exam_id' and question_id='$question_id  and question='$questions'";
