   ...
   <?php include("header.php")?>
                    <ul class="menu accordion-menu">
                       <li><a href="./index" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-home"></span><p>Dashboard</p></a></li>
                        ...
                        <li class="active"><a href="doubts.php" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-book"></span><p>Doubts</p></a></li>
                                    ...
                                    <div class="panel-body">
                                        <div role="tabpanel">
                                            ...
                                            <ul class="nav nav-tabs" role="tablist">
                                                ...
                                                <li role="presentation" class="active"><a href="#tab5" role="tab" data-toggle="tab">Assignments</a></li>
                                                <?php
                                                    ...
                                                    // }
                                                    // else{
                                                        echo '<li role="presentation"><a href="#tab6" role="tab" data-toggle="tab">Give Assignment</a></li>';
