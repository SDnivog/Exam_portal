      ...
      <?php include('header.php')?>
            ...
            <div class="page-inner">
                <div class="page-title">
                    <h3>Exam - <span class="text-primary"> <?php echo "$exam_name" ?></span>||  Result's Analytics</h3>
                                           ...
                                           if(isset($stu_id) and isset($exam_id)){
                                            ...
                                            $attempt_question = $count-$unattempt_answer;
                                               ...
                                               if($exam_row['section_name'] != ""){
                                                   $dis .= '<h3 class="text-center">Section Wise Marks</h3>';
                                                    $sec=explode('/', $exam_row['section_name']);
                                                        $i=0;
                                                            ...
                                                            $dis .= '<button class="btn btn-large btn-success" id="Section_name'.$i.'" type="button" onclick="Sectionchange('.$i.')" style="margin:5px;">'.$out.'</button>';
                                                                $i++;
                                            ...
                                            $section_attempt_answer[$j] = $section_count[$j]-$section_unattempt_answer[$j];
                                                            ...
                                                            $dis .= '<div   id="Section'.$j.'"  style="padding:10px 20px;border:1px solid #999;';
                                                            ...
                                                            <h3 class="text-weight-bold text-success">'.$out1.'</h3>
                                                            <h4>Total Marks Obtained  : '.$section_total_marks[$j].'</h4>
                                                            <h4>Total Correct Questions : '.$section_correct_answer[$j].'</h4>
                                                            <h4>Total Wrong Questions : '.$section_wrong_answer[$j].'</h4>
                                                            <h4>Total Attempt Question : '.$section_attempt_answer[$j].'</h4>
                                                            <h4>Total UnAttempt Question : '.$section_unattempt_answer[$j].'</h4> ';
                                                ...
                                                // $dis .= '  <button class="btn btn-success" style="width:50%; height:50px;font-size:20px;margin-left:50%;transform:translate(-50%,0%)">Download Result</button>
                                                // </div>';
                                                echo $dis;
